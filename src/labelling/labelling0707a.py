...
DIR_DATA_RAW_IMG0707A = "C:\\dev-data\\raw-img0707a\\"
...
# Open CSV
with open(DIR_DATA_LABEL + "label_img0707a.csv", "r") as fr:
	line = fr.readline()
	...
	while len(line)>2:
		...
		fpath_src = DIR_DATA_RAW_IMG0707A + fname + ".dcm"
		fpath_dst = DIR_DATA_LABELLED_CNN_DCM + "C" + cname + "-" + fname + "a.dcm"
