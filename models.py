...
class InceptionV1BasedModel(BaseModel):
    def __init__(self, num_class):
        ...
        self.params['fc6_W'] = tf.Variable(tf.random_normal([4096*4, 4096*4]), name='fc6_W')
        self.params['fc6_b'] = tf.Variable(tf.random_normal([4096*4]), name='fc6_b')

        self.params['fc7_W'] = tf.Variable(tf.random_normal([4096*4, 4096*4]), name='fc7_W')
        self.params['fc7_b'] = tf.Variable(tf.random_normal([4096*4]), name='fc7_b')

        self.params['fc8_W'] = tf.Variable(tf.random_normal([4096*4, num_class]), name='fc8_W')
